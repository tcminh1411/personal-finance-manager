            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-3 py-3 border-b border-gray-100 whitespace-nowrap">
                    <div class="flex gap-1.5 justify-center">
                        <button class="btn-edit" data-id="${tx.id}" data-category="${tx.category_id || ""}" data-action="edit">Sửa</button>
                        <button class="btn-delete" data-id="${tx.id}" data-action="delete">Xóa</button>
                    </div>
                </td>
            </tr>
        `;
